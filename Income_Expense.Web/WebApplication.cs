...
namespace Income_Expense.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class Income_ExpenseAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private Income_Expense.Module.Income_ExpenseModule module3;
        private Income_Expense.Module.Web.Income_ExpenseAspNetModule module4;
        ...
        static Income_ExpenseAspNetApplication() {
        ...
        #endregion
        public Income_ExpenseAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void Income_ExpenseAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new Income_Expense.Module.Web.Income_ExpenseAspNetModule();
            ...
            // 
            // Income_ExpenseAspNetApplication
            // 
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.Income_ExpenseAspNetApplication_DatabaseVersionMismatch);
