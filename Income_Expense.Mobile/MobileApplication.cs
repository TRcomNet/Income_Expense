...
namespace Income_Expense.Mobile {
    ...
    public partial class Income_ExpenseMobileApplication : MobileApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Mobile.SystemModule.SystemMobileModule module2;
        private Income_Expense.Module.Income_ExpenseModule module3;
        private Income_Expense.Module.Mobile.Income_ExpenseMobileModule module4;
        ...
        static Income_ExpenseMobileApplication() {
        ...
        #endregion
        public Income_ExpenseMobileApplication() {
            Tracing.Initialize();
        ...
        private void Income_ExpenseMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new Income_Expense.Module.Income_ExpenseModule();
            this.module4 = new Income_Expense.Module.Mobile.Income_ExpenseMobileModule();
            ...
            // 
            // Income_ExpenseMobileApplication
            // 
            this.ApplicationName = "Income_Expense";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.Income_ExpenseMobileApplication_DatabaseVersionMismatch);
